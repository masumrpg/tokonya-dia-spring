...
public class PermissionEvaluationServiceImpl implements PermissionEvaluationService {
    ...
    public boolean hasAccessToCustomer(String customerId, String userId) {
        ...
        return !userAccount.getRole().equals(UserRole.ROLE_CUSTOMER) && !userAccount.getRole().equals(UserRole.ROLE_SELLER) || userAccount.getId().equals(customer.getUserAccount().getId());
    }
}